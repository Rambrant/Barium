...
public class CrmServiceFailAgent extends Consumer
{
    private FailStateDao failDao;

    public CrmServiceFailAgent( ConsumerParameter parameter) throws ConsumerCreationFailedException
    {
        super( parameter);
    }
    ...
    protected void after() throws Exception
    {
        ...
        //
        failDao.create( CrmService.class.getSimpleName(), false);
    }

    @Override
    protected void handleFailStatusChange( boolean failState)
    {
        failDao.create( CrmService.class.getSimpleName(), failState);
    }
}
