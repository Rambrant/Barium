...
public class AxServiceFailAgent extends Consumer
{
    private FailStateDao failDao;

    public AxServiceFailAgent( ConsumerParameter parameter) throws ConsumerCreationFailedException
    {
        super( parameter);
    }
    ...
    protected void after() throws Exception
    {
        ...
        //
        failDao.create( AxService.class.getSimpleName(), false);
    }

    @Override
    protected void handleFailStatusChange( boolean failState)
    {
        failDao.create( AxService.class.getSimpleName(), failState);
    }
}
