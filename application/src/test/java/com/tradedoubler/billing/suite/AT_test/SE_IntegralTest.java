...
@ScenarioDefinition(
    model  = "suite/AT_test/se-integral-scenarios.xml",
    data   = "suite/AT_test/data/se-integral-data.xml")
public class SE_IntegralTest extends InvoicingSolutionScenario
{
}
