...
@ScenarioDefinition(
    model  = "suite/AT_test/de-affiliate-scenarios.xml",
    data   = "suite/AT_test/data/de-affiliate-data.xml")
public class DE_AffiliateTest extends InvoicingSolutionScenario
{
}
