...
@ScenarioDefinition(
    model = "suite/integration_test/pan-old-campaign-verification-GB-scenarios.xml",
    data  = "suite/integration_test/data/pan-old-campaign-verification-data.xml")
public class PanOldCampaignVerificationGB extends InvoicingSolutionScenario
{
}
