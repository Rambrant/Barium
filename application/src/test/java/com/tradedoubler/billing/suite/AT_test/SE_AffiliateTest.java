...
@ScenarioDefinition(
    model  = "suite/AT_test/se-affiliate-scenarios.xml",
    data   = "suite/AT_test/data/se-affiliate-data.xml")
public class SE_AffiliateTest extends InvoicingSolutionScenario
{
}
