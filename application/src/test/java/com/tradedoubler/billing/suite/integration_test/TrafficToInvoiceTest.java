...
@ScenarioDefinition(
    model = "suite/integration_test/TrafficToInvoice-scenario.xml",
    data  = "suite/integration_test/data/TrafficToInvoice-data.xml" )
public class TrafficToInvoiceTest extends InvoicingSolutionScenario
{
}
