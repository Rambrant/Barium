...
@ScenarioDefinition(
    model  = "suite/AT_test/es-integral-scenarios.xml",
    data   = "suite/AT_test/data/es-integral-data.xml")
public class ES_IntegralTest extends InvoicingSolutionScenario
{
}
