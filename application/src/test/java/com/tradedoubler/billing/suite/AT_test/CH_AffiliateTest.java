...
@ScenarioDefinition(
    model  = "suite/AT_test/ch-affiliate-scenarios.xml",
    data   = "suite/AT_test/data/ch-affiliate-data.xml")
public class CH_AffiliateTest extends InvoicingSolutionScenario
{
}
