...
@ScenarioDefinition(
    model = "suite/platform_test/platform-fail-test-scenario.xml",
    data  = "suite/platform_test/data/platform-fail-test-data.xml")
public class PlatformFailTest extends InvoicingSolutionScenario
{
}
