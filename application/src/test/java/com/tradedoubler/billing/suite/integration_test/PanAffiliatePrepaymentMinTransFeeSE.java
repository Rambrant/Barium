...
@ScenarioDefinition(
    model = "suite/integration_test/pan-affiliate-prepayment-min-trans-fee-scenario-SE.xml",
    data  = "suite/integration_test/data/pan-affiliate-prepayment-min-trans-fee-data.xml")
public class PanAffiliatePrepaymentMinTransFeeSE extends InvoicingSolutionScenario
{
}
